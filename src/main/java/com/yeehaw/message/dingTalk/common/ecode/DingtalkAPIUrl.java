...
public enum DingtalkAPIUrl {
	...
	GetDepartmentDetail("https://oapi.dingtalk.com/department/get","get","获取部门详情"),
	CreateDepartment("https://oapi.dingtalk.com/department/create","post","创建部门"),
	UpdateDepartment("https://oapi.dingtalk.com/department/update","post","更新部门"),
	DeleteDepartment("https://oapi.dingtalk.com/department/delete","get","删除部门"),
